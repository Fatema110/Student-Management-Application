...
st = "SHOW TABLES LIKE 'fatema1'"
cursor.execute(st)
result = cursor.fetchone()
studentSQL= """CREATE TABLE fatema1(ID BIGINT(20) PRIMARY KEY,
...
def subdata():
    ...
    if valrn==True and valmn==True and valei==True and valsi==True and valfn==True and valln==True and valsa==True:
        sql= "INSERT INTO fatema1(ID,FIRSTNAME,LASTNAME,ADDRESS,ROLLNO,EMAIL,DOB,GENDER,NUMBER,PHOTO) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"""
